...
class ReportsController extends Controller
{
    ...
    public function generateReportsTotal()
    {
        $categorySales = Product::select('category', DB::raw('
                ...
                SUM(trans.total_sales * products.retail_price) as total_prices,
                SUM((trans.total_quantity - (trans.closing + trans.total_sales)) * products.retail_price) as descrepancy
            '))
    ...
    public function generateReportsTotalUserDate($id, $date)
    {
        ...
        // Return the category sales data
        return $categorySales;
    }
